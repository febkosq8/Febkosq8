...
export default function Header() {
	...
	return (
		<div className="sticky top-0 z-[50] flex h-16 w-full items-center justify-between border-b-2 bg-background px-4 text-sm sm:px-8 sm:text-base md:px-16 md:text-lg lg:text-xl">
